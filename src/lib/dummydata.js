export const listData = [
    {
      ...
      bathroom: 1,
      price: 1000,
      address: "Mig 20 Street No. 10B Scindhya Nagar, DUrg",
      latitude: 21.1904,
      longitude:  81.2849,
    },
    {
      ...
      bathroom: 2,
      price: 1500,
      address: "Qtr no 467/3/B Balco Nagar, Korba",
      latitude: 22.3982,
      longitude: 82.7400,
    },
    {
      id: 3,
      title: "A New Apartment in the City! Near Apollo Hospital",
      images: ["https://images.pexels.com/photos/2062426/pexels-photo-2062426.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"],
      bedroom: 1,
      bathroom: 1,
      price: 800,
      address: "Tower C-204 Pearl Heights, Bilaspur ",
      latitude: 22.0797,
      longitude: 82.1409,
    },
    {
